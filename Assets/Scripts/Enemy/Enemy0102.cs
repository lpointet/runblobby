...
public class Enemy0102 : Enemy {
	...
	protected override void Update () {
		...
		if (IsDead () || LevelManager.player.IsDead () || TimeManager.paused || popEnemy)
			return;
		...
		if (!angry) {
			...
			// Elle s'arrête à sa position initiale
	...
	public override void Hurt(float damage, int penetration = 0, bool ignoreDefense = false, Character attacker = null) {
		...
		// Impact de balles
		featherParticle.Play (); // TODO ne se déclenche pas la première fois, pourquoi ?
